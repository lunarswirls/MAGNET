...
# -*- coding: utf-8 -*-
"""
Run Amitis test to reproduce Fig. 9
"""
# Imports
import os
import datetime
...
rmse_testing = False
corr_testing = False
input_dir = example_data_path("Amitis_test")
input_dir.mkdir(parents=True, exist_ok=True)

test = "am285_imf45_rotated_B"
input_file = input_dir / f"lvx_pos-llo_lclf_amitis_alloutput_{test}.csv"

raw_df = pd.read_csv(input_file)

# cut to just before point where lander begins descent for landing
input_df = raw_df[raw_df['elapsed_time'] > 535000]

raw_bfield_df, thruster_df = FieldUtils.generate_amitis_field(input_df)

dt = raw_bfield_df['time_fmt'].to_numpy()
...
b1_field_nT = b1_field * 1e9  # units nT
...
bg_mag = raw_bfield_df['BG_mag'].to_numpy()
...
print("Finished with Amitis test")
