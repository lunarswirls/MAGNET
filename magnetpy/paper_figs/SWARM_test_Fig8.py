...
# -*- coding: utf-8 -*-
"""
Run SWARM test to reproduce Fig. 8
"""
# Imports
import datetime
import numpy as np
...
rmse_testing = False
corr_testing = False
input_dir = example_data_path("SWARM_test")
input_dir.mkdir(parents=True, exist_ok=True)

test = "swarm_a_vfm_bgeo_20250915"
input_file = input_dir / f"{test}.csv"

input_df = pd.read_csv(input_file)

raw_bfield_df, thruster_df = FieldUtils.generate_swarm_field(input_df)
...
print("Finished with SWARM test")
